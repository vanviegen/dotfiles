...
syn region  phpInlineRuby matchGroup=None start="<%"  end="%>" 
syn region  phpInterpolation matchGroup=None start="{{" end="}}" contained
syn region  phpStringH matchGroup=Delimiter start="-----*"  end="-----*"  contains=@htmlPreproc,phpInterpolation,phpInlineRuby
syn region  phpStringH matchGroup=Delimiter start="=====*"  end="=====*"  contains=@htmlPreproc,phpInterpolation,phpInlineRuby
syn cluster phpClConst add=phpStringH,phpInlineRuby
syn cluster phpAddStrings add=phpInlineRuby
...
if version >= 508 || !exists("did_php_syn_inits")
  ...
  HiLink   phpInterpolation Special
  HiLink   phpInlineRuby  Label
  HiLink   phpStringH  String
