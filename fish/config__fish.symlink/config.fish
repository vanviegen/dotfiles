if status is-interactive
    ...
    alias open xdg-open
    alias cs rg
    alias toad "uv tool run --from batrachian-toad toad"
    ...
    echo "💡  "(set_color --bold cyan)"ctrl-alt-l"(set_color normal)" git log   "(set_color --bold cyan)"ctrl-s"(set_color normal)" git status   "(set_color --bold cyan)"ctrl-alt-f"(set_color normal)" file   "(set_color --bold cyan)"ctrl-alt-p"(set_color normal)" pid   "(set_color --bold cyan)"ctrl-v"(set_color normal)" var   "(set_color --bold cyan)"tab"(set_color normal)" select (within fzf)"
